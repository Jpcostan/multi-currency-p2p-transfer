...
describe('TransactionService', () => {
  ...
  describe('transfer', () => {
    it('should transfer USD to USD successfully', () => {
      const result = service.transfer(aliceId, {
    ...
    it('should transfer with currency conversion (USD to EUR)', () => {
      const result = service.transfer(aliceId, {
        recipientIdentifier: TEST_USERS.bob.email,
        fromCurrency: 'USD',
        toCurrency: 'EUR',
    ...
    it('should transfer with currency conversion (USD to BTC)', () => {
      const result = service.transfer(aliceId, {
        recipientIdentifier: TEST_USERS.bob.email,
        fromCurrency: 'USD',
        toCurrency: 'BTC',
    ...
    it('should find recipient by username', () => {
      const result = service.transfer(aliceId, {
    ...
    it('should debit sender and credit recipient atomically', () => {
    ...
    it('should throw BusinessRuleError for self-transfer', () => {
      expect(() => {
        service.transfer(aliceId, {
    ...
    it('should throw NotFoundError for non-existent recipient', () => {
      expect(() => {
        service.transfer(aliceId, {
  ...
  describe('getTransaction', () => {
    ...
    it('should allow recipient to view transfer transaction', () => {
      // Create a transfer
      const transferResult = service.transfer(aliceId, {
        recipientIdentifier: TEST_USERS.bob.email,
        fromCurrency: 'USD',
        toCurrency: 'USD',
        amount: 50,
